import { Box, Button, MultiSelect, TextInput, Textarea } from "@mantine/core";
import { useEffect, useState } from "react";
import { getTags } from "../apis/tags";
import { isNotEmpty, useForm } from "@mantine/form";
import { DEFAULT_ARTICLE } from "../models/article";

export default function FormArticle({ article, handleSubmit, onSubmit }) {
